...
import { MathRun, MathRadical, MathFraction, MathSum, MathSubScript, MathSuperScript, LevelFormat, AlignmentType, convertInchesToTwip, Document, Packer, Math, Paragraph, FootnoteReferenceRun, ImageRun, ExternalHyperlink, TextRun, Table, TableRow, TableCell, HeadingLevel } from 'docx';
...
const buildParagraph = ({ children }, ctx) => {
    ...
    return new Paragraph(Object.assign({ children: nodes, indent: ctx.indent > 0
            ? {
