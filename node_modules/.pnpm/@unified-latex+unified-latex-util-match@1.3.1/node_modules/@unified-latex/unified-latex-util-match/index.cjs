...
// index.ts
var unified_latex_util_match_exports = {};
__export(unified_latex_util_match_exports, {
  anyEnvironment: () => anyEnvironment,
  anyMacro: () => anyMacro,
  anyString: () => anyString,
  argument: () => argument,
  blankArgument: () => blankArgument,
  comment: () => comment,
...
module.exports = __toCommonJS(unified_latex_util_match_exports);
...
var match = {
  ...
  environment(node, envName) {
    ...
    return (node.type === "environment" || node.type === "mathenv") && (envName == null || (0, import_unified_latex_util_print_raw.printRaw)(node.env) === envName);
  },
  anyEnvironment(node) {
