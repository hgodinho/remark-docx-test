 ...
 */
type GuardFromOptions<Opts extends VisitOptions, PossibleTypes = Ast.Ast> = Opts extends {
    test: infer R;
 ...
 */
type VisitorTypeFromOptions<Opts extends VisitOptions> = NarrowArraysBasedOnOptions<GuardFromOptions<Opts>, Opts>;
/**
 ...
 */
type Visitor<T> = (node: T, info: VisitInfo) => null | undefined | Action | Index | ActionTuple | void;
type Visitors<T> = {
    enter?: Visitor<T>;
    leave?: Visitor<T>;
};
